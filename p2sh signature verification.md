...
After having the signature message, we can extract the sec of public key, der of signature and the redeem script from the scriptsig of the input as following
